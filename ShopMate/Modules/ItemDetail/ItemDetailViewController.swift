...
private extension ItemDetailViewController {
    func initialize() {
      view.backgroundColor = .background
        ...
        [imageView, titleLabel, itemDescription, priceLabel, categoryLabel, addToCartButton, activityIndicator].forEach {
            view.addSubview($0)
      ...
      NSLayoutConstraint.activate([
                  ...
                  addToCartButton.topAnchor.constraint(equalTo: categoryLabel.bottomAnchor, constant: 16),
